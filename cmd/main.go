...
func main() {
	...
	setThenReadMode(client, rigctld.CW, 100)
	setThenReadFreq(client, 14050000)
	setThenReadMode(client, rigctld.USB, 3000)
}
...
func setThenReadMode(client rigctld.Client, mode rigctld.Mode, bandpass rigctld.Frequency) {
